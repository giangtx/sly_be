...
Groupuser.belongsTo(User, { foreignKey: "created_by" });
Groupuser.hasMany(GroupMember, { foreignKey: "id_group"})

GroupMember.belongsTo(User, { foreignKey: "id_user" });

export { User, Role, Chat, MemberChat, Message, Post, PostLike, PostComment, Image, Friend, GroupMember, Groupuser };
